...
import com.designre.blog.mapper.ArticleMapper;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements ArticleService {
    ...
    public void delete(Integer id) {
        ...
        log.info("deleting the corresponding comments, qty: {}", commentsResult);
    ...
    public void increaseHits(Integer id, Integer increaseHits) {
        ...
        if (update < 1) {
            ...
            throw new TipException("Article update hits failed");
        }
    }
